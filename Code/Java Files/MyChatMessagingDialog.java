...
public class MyChatMessagingDialog
    extends Dialog
    implements ActionListener, ItemListener, KeyListener, WindowListener
{
    ...
    public MyChatMessagingDialog(MyChatWindow parent)
    {
	...
	if ((instantUser == null) && saveUser.equals(""))
	    {
		new MyChatInfoDialog(parentWindow, "Need recipient", true,
	...
	if (parentWindow.connected != true)
	    {
		new MyChatInfoDialog(parentWindow, "Not connected", true,
	...
	if (!saveUser.equals(""))
		...
		for (int count = 0; count < usersVector.size(); count ++)
		    {
			MyChatUser user =
			    (MyChatUser) usersVector.elementAt(count);
