...
public class MyChatRoomControl
    extends Dialog
    implements ActionListener, ItemListener, KeyListener, WindowListener
{
    ...
    MyChatRoomControl(Frame parent)
    {
    ...
    private boolean userInRoom(String userName, MyChatRoomInfo room)
    {
	...
	MyChatRoomInfo currentRoom = parentWindow.currentRoom;
	...
	for (int count = 0; count < usersVector.size(); count ++)
	    {
		MyChatUser user = (MyChatUser) usersVector.elementAt(count);
