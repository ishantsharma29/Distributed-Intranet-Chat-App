...
public class MyChatUserToolDialog
    extends Dialog
    implements ActionListener, ItemListener, KeyListener, WindowListener
{
    private MyChatUserTool userTool = new MyChatUserTool();

    protected MyChatServerWindow parentWindow;
    ...
    public MyChatUserToolDialog(MyChatServerWindow parent)
    {
	...
	String encryptedPassword = new MyChatPasswordEncryptor()
	...
	try {
	    ...
	    new MyChatInfoDialog(parentWindow, "Error creating user",
				  true, e.toString());
	    return;
	}
	...
	for (int count = 0; count < users.length; count ++)
		...
		try {
		    ...
		    new MyChatInfoDialog(parentWindow, "Error deleting user",
					  true, e.toString());
		    return;
		}
	    }
