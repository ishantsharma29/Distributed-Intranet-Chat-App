...
class MyChatLine
{
    ...
    public MyChatLine(Color mycolor, int mystartx, int mystarty,
...
class MyChatRectangle
{
    ...
    public MyChatRectangle(Color mycolor, int myx, int myy, int mywidth,
...
class MyChatOval
{
    ...
    public MyChatOval(Color mycolor, int myx, int myy, int mywidth,
		       int myheight, boolean myfill, int mythickness)
    {
	color = mycolor;
	x = myx;
...
class MyChatText
{
    ...
    public MyChatText(Color mycolor, int myx, int myy, int myfontnumber,
...
class MyChatPicture
{
    ...
    public MyChatPicture(int myX, int myY, int myWidth, int myHeight,
    ...
    extends Canvas
{
    ...
    public String text;
    public MyChatWindow parentWindow;
    
    public MyChatSampleCanvas(MyChatWindow mainWindow)
    {
	super();
	...
	repaint();
	setVisible(true);
	text = new String("MyChat and on");
    }

    public void paint(Graphics g)
    {
	g.setColor(Color.black);
	g.setFont(new Font(MyChatCanvas
...
class MyChatFontSelect
    extends Dialog
    implements ActionListener, ItemListener, KeyListener, WindowListener
{
    private GridBagLayout myLayout;
    private GridBagConstraints myConstraints;
    private MyChatWindow parentWindow;
    ...
    private MyChatSampleCanvas sample;
    ...
    public MyChatFontSelect(Frame parent)
    {
	super(parent, "Choose font", true);
	parentWindow = (MyChatWindow) parent;
	...
	sample = new MyChatSampleCanvas(parentWindow);
	myConstraints.gridx = 0; myConstraints.gridy = 1;
	myConstraints.gridheight = 1; myConstraints.gridwidth = 1;
	...
	parentWindow.canvas.draftText = 
	    new MyChatText(parentWindow.canvas.drawColor,
    ...
    implements MouseListener, MouseMotionListener
{
    ...
    // For the draft stuff
    private MyChatLine draftLine;
    private MyChatRectangle draftRect;
    private MyChatOval draftOval;
    protected MyChatText draftText;
    protected MyChatPicture draftPicture;
    ...
    public MyChatCanvas(MyChatWindow parent)
    {
	super();
	parentWindow = parent;
	...
	try {
	    ...
	    new MyChatInfoDialog(parentWindow, "Failed", true, e.toString());
	    return;
	}
	...
	draftPicture =
	    new MyChatPicture(10, 10, theImage.getWidth(this),
	...
	g1.setFont(new Font (MyChatCanvas.fontArray[fontnumber],
				    attribs, size));
	g2.setFont(new Font (MyChatCanvas.fontArray[fontnumber],
				    attribs, size));
	...
	if (drawType == this.LINE)
	    {
		draftLine = new MyChatLine(drawColor, oldx, oldy, oldx,
					    oldy, drawThickness);
	    ...
	    {
		draftOval = new MyChatOval(drawColor, oldx, oldy,
	    ...
	    {
		draftRect = new MyChatRectangle(drawColor, oldx, oldy,
						 1, 1, false, drawThickness);
	...
	if (parentWindow.connected)
		...
		parentWindow.theClient
		    .sendActivity(MyChatCommand.ACTIVITY_DRAWING);
	    }
	    catch (IOException e) {
	...
	if (floatingPicture)
		...
		if (floatingText)
		    ...
		    {
			new MyChatFontSelect(parentWindow);
