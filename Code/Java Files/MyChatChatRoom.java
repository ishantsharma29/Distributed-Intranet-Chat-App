...
public class MyChatChatRoom
{
    // This class is used to manage chat rooms.  It's defined in its own
    // source file because it is used by both the MyChatserver and
    // MyChatClientSocket classes
    ...
    MyChatChatRoom(String myName, String myCreator, boolean isPrivate,
		    String myPassword)
    {
	name = myName;
    ...
    public void addClient(MyChatClientSocket newClient)
    {
    ...
    public void remClient(MyChatClientSocket oldClient)
    {
