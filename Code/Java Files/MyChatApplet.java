...
public class MyChatApplet
    extends Applet
{
    // This is just a simple applet wrapper class to allow MyChat Chat
    ...
    {
	return ("MyChat Chat version " + MyChat.VERSION
		+ " by MNNIT Students");
    }
	...
	String[][] args = {
	    ...
	    { servernameParam, "string",
	      "Internet hostname/address of MyChat Chat server" },
	...
	window = new MyChatWindow(name, password, host, port, showCanvas,
				   getCodeBase());
